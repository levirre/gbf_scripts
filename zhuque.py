...
def clicksummon():
    ...
    pyautogui.moveTo(xtop+410,ytop+600)
    time.sleep(1)
    pyautogui.click()
    back()
def clickattack():
...
def search_summons():
    summons= ["water.png","eu140.png","lev140.png","lev120.png",]
...
char1 = {'pos': (xtop+110,ytop+640),'skills':[s4,s1,s2]}
char2 = {'pos': (xtop+200,ytop+640),'skills':[s1,s3]}
char3 = {'pos': (xtop+280,ytop+640),'skills':[s1,s2]}
char4 = {'pos': (xtop+360,ytop+640),'skills':[s1]}
char2_2 = {'pos': (xtop+200,ytop+640),'skills':[s1]}
