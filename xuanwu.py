...
summon=(xtop+450,ytop+620)
support=(xtop+190,ytop+620)
...
char1 = {'pos': (xtop+110,ytop+640),'skills':[s4,s1,s2,s3]}
#char2 = {'pos': (xtop+200,ytop+640),'skills':[s1,s3]}
char3 = {'pos': (xtop+290,ytop+640),'skills':[s1,s3]}
char4 = {'pos': (xtop+380,ytop+640),'skills':[s1,s2]}
chars=[char3,char4,char1,]
